...
#(lambda (grob) (grob-interpret-markup grob (markup #:draw-circle 0.5 0.15 #f)))
\once \override NoteHead #'style = #'mensural
\once \override NoteHead.whiteout = ##t
\once \override NoteHead.layer = #2
}

airf = { \once \override NoteHead #'stencil = %#(lambda (grob) (grob-interpret-markup grob (markup "○")))
#(lambda (grob) (grob-interpret-markup grob (markup #:draw-circle 0.5 0.15 #t)))
\once \override NoteHead #'style = #'mensural
\once \override NoteHead.whiteout = ##t
\once \override NoteHead.layer = #2
}
